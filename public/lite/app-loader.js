...
source = source.replace(surfaceModeStateMarker, [
  ...
  "function restorePlanetaryPresentation(){for(const state of planetaryMaterialState){if(state.material.transparent!==state.transparent){state.material.transparent=state.transparent;state.material.needsUpdate=true}state.material.opacity=state.opacity;state.material.depthWrite=state.depthWrite}surfaceMesh.material.opacity=1;surfaceMesh.material.transparent=false;surfaceMesh.material.needsUpdate=true;waterMesh.material.opacity=.58;plantMesh.material.opacity=1;animalMesh.material.opacity=1;riverLines.material.opacity=.92;delete document.body.dataset.surfaceSpanKm;delete document.body.dataset.surfaceZoomBlend;delete document.body.dataset.planetaryZoom}",
