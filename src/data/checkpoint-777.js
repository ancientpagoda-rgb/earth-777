...
export const CHECKPOINT_777 = Object.freeze({
  ...
  layers: Object.freeze({
    ...
    vegetation: Object.freeze({ status: "published Krapp BIOME4 777 ka biome/NPP/LAI checkpoint + model-derived hydro-CO₂ response + independent BIOME4 4.1 PFT climate eligibility, daily rooting/phenology diagnostics and parallel mass-conserving candidate water trials", target: "humidity/VPD-constrained PFT transpiration, optimized PFT LAI/NPP, fire/dryness diagnostics, competition and categorical biome transitions", sources: ["krapp-2021", "biome4-4.1-soil"] }),
