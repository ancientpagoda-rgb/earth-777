export const EARTH_SYSTEM_STATUS = Object.freeze({
  ...
  vegetation: Object.freeze({ mode: "competitive-spatial-materialization", status: "dynamic-partial", note: "NPP/LAI/PFT physiology respond to climate, water, CO2 and nitrogen; selected-region PFT competition drives lagged broad biome succession while shared PFT hydrology feedback remains incomplete." }),
  fauna: Object.freeze({ mode: "open-lineage-evolution", status: "dynamic-partial", note: "Anonymous species lineages compete for energy, adapt traits, speciate and go extinct without an imposed richness ceiling; spatial individual demography remains future work." }),
...
export const DYNAMIC_STATE_FIELDS = Object.freeze([
  ...
  "tectonicBoundaryActivity", "productivityIndex", "herbivoreBiomass", "carnivoreBiomass", "homininPopulationIndex",
