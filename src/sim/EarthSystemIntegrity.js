export const EARTH_SYSTEM_STATUS = Object.freeze({
  ...
  fauna: Object.freeze({ mode: "open-lineage-evolution", status: "dynamic-partial", note: "Anonymous species lineages compete for energy, adapt traits, speciate and go extinct without an imposed richness ceiling; the aggregate ecology owner now applies a provisional trait-shaped predation loss, while spatial individual demography remains future work." }),
